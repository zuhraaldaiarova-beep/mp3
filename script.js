...
let sound11=document.getElementById("ones")
let sound22=document.getElementById("twos")
let sound33=document.getElementById("threes")
...
sound22.addEventListener("click",function(){
    music2.pause()
})
sound33.addEventListener("click",function(){
    music3.pause()
})